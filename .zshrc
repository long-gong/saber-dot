...
export ZSH=/home/saber/.oh-my-zsh
...
export PATH=/usr/local/rbenv/bin:$HOME/.rbenv/plugins/ruby-build/bin:$PATH
export PATH="$HOME/.rbenv/bin:$PATH"
eval "$(rbenv init -)"
export PATH="/usr/local/phantomjs-1.9.8-linux-x86_64/bin:$PATH"
export FOOD2FORK_KEY="b90bd04c71af291fcd8f57a9aa2efe87"
